...
<form class="layui-form" action="../jiaojie/insert.do">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="date"  name="jieshou" required  lay-verify="required" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">交接时间：</label>
        <div class="layui-input-block">
            <input type="text"   name="jiaojietime" required  lay-verify="required" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
